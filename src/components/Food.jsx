...
const Food = () => {
  return (
    <div className='w-full h-fit pb-20 relative flex justify-center bg-black'>
         <div className='w-full absolute flex justify-between h-[20%]'><img src={food1} className='h-full max-lg:h-30 max-lg:w-30  max-lg:object-fill'/><img src={logo1} className='pr-10 p-10 max-lg:pr-3 max-lg:h-20 max-lg:w-30 max-lg:object-cover'/></div> 
