...
const Events = () => {
  return (
    <div className='w-full h-[550px]  relative flex items-center max-lg:flex-col max-lg:py-10  bg-cover bg-center bg-no-repeat'
    style={{backgroundImage:`url(${event})`}}>
         ...
         <div className='w-full h-full absolute max-lg:static p-10 pr-20 flex justify-end'>
