  ...
  return (
    <div className='bg-black w-full text-white flex gap-2 max-lg:flex-col h-fit overflow-hidden'>
     <div className='w-[65%] max-lg:w-full flex flex-col gap-7 p-20 max-lg:px-5 max-lg:py-10 py-36 h-full'>
        ...
        <a href="tel:+44 7438865788" className='flex gap-5 rounded-full border border-white max-lg:text-sm max-lg:px-4 max-lg:gap-2 px-8 py-3 items-center w-fit'><MdOutlinePhone className='text-xl'/>Call or Book</a>
     </div>
