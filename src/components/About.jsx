...
const About = () => {
  return (
    <div className='w-full h-fit overflow-hidden bg-cover grid text-white font-albert-sans grid-cols-2 bg-no-repeat'
    style={{backgroundImage:`url(${about})`}}>
            ...
            <div className='w-full h-full flex flex-col bg-gradient-to-r gap-10 items-center justify-center py-14 from-black/20 via-neutral-950 to-black '>
                 <img src={logo} className='h-56 w-64 object-cover'/>
                 <div className='w-8/12 flex justify-center flex-col items-center' >
                 <span className='flex justify-start pb-2 w-9/12'><BiSolidQuoteAltLeft className='text-2xl'/></span>
                    <p className='text-xl text-center w-8/12'>
