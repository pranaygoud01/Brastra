        ...
        <div  className='flex relative justify-between max-lg:flex-col'>
            ...
            <div className='w-full flex justify-end py-10 pr-72 max-lg:p-4 h-full max-lg:static absolute'>
                <div className='bg-white/12 max-lg:w-full h-full flex flex-col py-8 items-center gap-2 w-4/12 rounded-xl'>
                     ...
                     <p className='font-bold font-albert-sans max-lg:text-xl text-xl'>Skilled Chefs</p>
                     <p className='text-xs w-9/12 text-center max-lg:text-sm text-neutral-400'>excellent culinary skills, time management expertise, the ability to work</p>
                     <IoReceiptSharp className='text-5xl mt-3  max-lg:text-4xl text-red-500'/>
                     <p className='font-bold font-albert-sans max-lg:text-xl text-xl'>Unique Recipes</p>
                     <p className='text-xs w-9/12 pb-5 text-center max-lg:text-sm text-neutral-400'>Having an extra visual element around these items on your menu will help attract your guest's </p>
                </div>
        </div>
        </div>
